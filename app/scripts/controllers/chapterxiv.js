  ...
  .controller('ChapterxivCtrl', function ($scope, ColorPickerService) {
	...
	$scope.plate2 = {
		...
		color5 : ColorPickerService.makeColorPicker("#267ca5"),
			color6 : ColorPickerService.makeColorPicker("#544a49"),
				color7 : ColorPickerService.makeColorPicker("#fc6d40"),
		color8 : ColorPickerService.makeColorPicker("#1a72a1"),
			color9 : ColorPickerService.makeColorPicker("#503e3c"),
				color10 : ColorPickerService.makeColorPicker("#fc6640"),
		color11 : ColorPickerService.makeColorPicker("#67abc7"),
			color12 : ColorPickerService.makeColorPicker("#887378"),
				color13 : ColorPickerService.makeColorPicker("#fc9458"),
		color14 : ColorPickerService.makeColorPicker("#4f9ec0"),
			color15 : ColorPickerService.makeColorPicker("#896264"),
